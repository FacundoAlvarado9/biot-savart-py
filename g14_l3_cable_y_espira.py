# -*- coding: utf-8 -*-
"""G14_L3_Cable_y_Espira.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Kf_H-2YLieq6AsS_91iMoPQOPby8LBay
...
A partir de la experiencia: Un valor positivo de corriente, en términos de la espira circular, implica que la corriente circula en sentido anti-horario. Un valor negativo, entonces, circulará en sentido horario. (Esta aclaración es en términos de nuestra solución)
"""

l = [smp.Matrix([-1+2*t, 0, 0]), #Cable recto
    smp.Matrix([2*smp.cos(2*np.pi*t), 2*smp.sin(2*np.pi*t), 0])] #Espira circular
I = [5, -5]

"""Veamos a continuación la ecuación de la línea que representa una espira circular"""
